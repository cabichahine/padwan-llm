...
class OutputError(Exception):
    ...
    Raised when the model never calls the output tool (it answered in text, or hit the
    round limit), or when its answer fails validation more than `max_repairs` times.
    """
